...
function CommentForm({
    ...
    const handleSubmit = (event) => {
        ...
        // If it was a reply, also signal that reply mode should end (optional, parent might do this)
        // The parent component (`CommentSection`) is generally responsible for clearing
        // the `replyingTo` state after the API call succeeds.
