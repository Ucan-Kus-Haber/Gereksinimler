...
const NewsArticle = () => {
    ...
    const handleRelatedArticleClick = (relatedArticle) => {
        navigate(`/news/${relatedArticle.slug || relatedArticle.id}`);
    };
        ...
        <div className="article-page">
            <div className="article-container">
                <div className="breadcrumb">
                    ...
                    <span> > </span>
                    <span onClick={() => handleCategoryClick(article.category)} style={{ cursor: 'pointer' }}>
                        {article.category}
                    </span>
                    <span> > </span>
                        ...
                        {relatedArticles.slice(0, 3).map((relArticle) => {
                            ...
                            return (
                                <div
                                    ...
                                    onClick={() => handleRelatedArticleClick(relArticle)}
                                    style={{ cursor: 'pointer' }}
                                >
