        ...
        <div className="rectangular-container">
            ...
            {randomArticle && (
                <div className="random-news-section">
                    ...
                    <div className="rectangular-box" onClick={() => handleArticleClick(randomArticle)}>
                        ...
                        <div className="rectangular-content">
                            ...
                            <div className="rectangular-actions" style={{ display: 'flex', gap: '10px', marginTop: '10px' }}>
                                <button className="rect-action-button" title="Like" onClick={(e) => e.stopPropagation()}>
                                    👍
                                </button>
                                <button className="rect-action-button" title="Dislike" onClick={(e) => e.stopPropagation()}>
                                    👎
                                </button>
                                <button className="rect-action-button" title="Add to Favorites" onClick={(e) => e.stopPropagation()}>
                                    ⭐
                                </button>
                            </div>
                        </div>
            ...
            <div className="rectangular-grid">
                {displayArticles.map((article, index) => (
                    <div key={article.id || index} className="rectangular-item">
                        <div className="rectangular-box" onClick={() => handleArticleClick(article)}>
                            <div className="rectangular-image">
                                {article.imageUrl && (
                                    <img
